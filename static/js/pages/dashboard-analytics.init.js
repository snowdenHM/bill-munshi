...
function loadCharts() {
    ...
    e && (document.getElementById("users-by-country").innerHTML = "", worldlinemap = "", worldlinemap = new jsVectorMap({
        ...
        }, {name: "Brazil", coords: [-14.235, -51.9253]}, {name: "Egypt", coords: [26.8206, 30.8025]}, {
            name: "Russia",
            coords: [61, 105]
        }, {name: "China", coords: [35.8617, 104.1954]}, {
            name: "United States",
            coords: [37.0902, -95.7129]
        }, {name: "Norway", coords: [60.472024, 8.468946]}, {name: "Ukraine", coords: [48.379433, 31.16558]}],
        ...
        regionStyle: {initial: {stroke: "#9599ad", strokeWidth: .25, fill: e, fillOpacity: 1}},
...
function generateData(e, t) {
    for (var a = 0, o = []; a < e;) {
        var r = (a + 1).toString() + "h", n = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min;
        o.push({x: r, y: n}), a++
    }
    return o
}
...
var columnoptions, options, chart, chartHeatMapBasicColors = getChartColorsArray("audiences-sessions-country-charts"),
    chartAudienceColumnChartsColors = (chartHeatMapBasicColors && (options = {
        ...
        plotOptions: {
            heatmap: {
                colorScale: {
                    ranges: [{from: 0, to: 50, color: chartHeatMapBasicColors[0]}, {
                        from: 51,
                        to: 100,
